...
vi.mock("@composables/useApiClient", () => ({
    useApiClient: () => ({
        getRateableHistory: mockGetRateableHistory.mockResolvedValue({
            data: [],
        }),
        getLastUpdated: vi
            .fn()
...
describe("HomePage.vue", () => {
    ...
    it.skip("destroys charts on unmount", () => {
        ...
        (wrapper.vm as any).soloChartInstance = {
            destroy: soloDestroySpy,
        } as unknown as Chart;
        (wrapper.vm as any).teamChartInstance = {
            destroy: teamDestroySpy,
        } as unknown as Chart;
